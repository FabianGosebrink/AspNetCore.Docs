...
### MySql.Data.EntityFrameworkCore currently not supported on ASP.NET Core 3.0

For more information, see [this GitHub issue](https://github.com/aspnet/EntityFrameworkCore/issues/17788).